...
namespace Drupal\productos\Others;
...
class XLSXWriter {
  ...
  private function addCellStyle($number_format, $cell_style_string) {
    ...
    $cell_style_idx = self::addToListGetIndex($this->cellStyles, $lookup_string);
  ...
  public function countSheetRows($sheet_name = '') {
    $sheet_name = $sheet_name ?: $this->currentSheet;
   ...
   *
   * @return Cell
   *   Label/coordinates, ex: A1, C3, AA42 (or if $absolute==true: $A$1, $C$3, $AA$42)
   */
